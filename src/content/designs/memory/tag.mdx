...
import tagmemory from 'tag/tag-memory-1.jpg';
...
Tag memory is basically like [loop memory](/designs/memory/loop), except each loop only has a length of 1. This makes it significantly easier to use.
...
<Image src={tagmemory} alt="Tag Memory" />
